...
import { CreateResourceInfoInput, GetResourceInfosInput, GetResourcesInput, Resource, ResourceInfo, ResourceInfoList, ResourceList, UpdateResourceInfoInput } from "../models/domain-layer/legacy/resource";
