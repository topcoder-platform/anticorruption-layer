...
class PhaseFactQueryHelper {
      ...
      query: {
        ...
        raw: {
          ...
          FROM project p
            ...
            LEFT JOIN review r on r.submission_id = s.submission_id AND r.committed = 1
      ...
      query: {
        ...
        raw: {
          ...
          FROM project p
            ...
            LEFT JOIN review r on ph.project_phase_id = r.project_phase_id AND r.committed = 1
  ...
  public getIterativeReviewScoreByProjectPhaseIdQuery(projectPhaseId: number): Query {
    return {
      query: {
        $case: "raw",
        raw: {
          query: `
          SELECT r.review_id, r.resource_id, r.initial_score, r.score, s.min_score, r.submission_id
          FROM review r
            INNER JOIN scorecard s on s.scorecard_id = r.scorecard_id
          WHERE r.project_phase_id = ${projectPhaseId}`,
        },
      },
    };
  }
