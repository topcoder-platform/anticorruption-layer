...
export const GetSinglePrizeInput = {
  encode(message: GetSinglePrizeInput, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.projectId !== 0) {
  ...
  create<I extends Exact<DeepPartial<GetSinglePrizeInput>, I>>(base?: I): GetSinglePrizeInput {
    return GetSinglePrizeInput.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<GetSinglePrizeInput>, I>>(object: I): GetSinglePrizeInput {
    const message = createBaseGetSinglePrizeInput();
    message.projectId = object.projectId ?? 0;
    message.prizeTypeId = object.prizeTypeId ?? 0;
    message.place = object.place ?? 0;
