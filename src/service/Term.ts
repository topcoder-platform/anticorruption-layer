...
import {
  LegacyTermServer,
  LegacyTermService
} from "../models/domain-layer/legacy/services/term";

import { CreateResult, Empty } from "@topcoder-framework/lib-common";
import LegacyTermDomain from "../domain/Term";
import { GetProjectRoleTermsOfUseXrefInput, ProjectRoleTermsOfUseXrefList, CreateProjectRoleTermsOfUseXrefInput, DeleteProjectRoleTermsOfUseXrefInput } from "../models/domain-layer/legacy/term";
